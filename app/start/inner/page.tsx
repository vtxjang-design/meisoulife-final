...
export default function StartInnerPage() {
  return (
    <div className="section-shell py-16 sm:py-24">
      <div className="mx-auto max-w-3xl">
        <section className="premium-card rounded-[28px] p-8 text-center sm:p-12">
          <p className="text-sm uppercase tracking-[0.32em] text-gold/80">Inner Start</p>
          <h1 className="mt-4 font-serif text-4xl leading-tight text-white sm:text-5xl">Inner Circleの入り口です</h1>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/68">
            ここから、深い静けさとプレミアムな実践の流れへ静かに入っていけます。
          </p>
