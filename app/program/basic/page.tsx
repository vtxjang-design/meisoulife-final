...
function BasicSidebar() {
  ...
  return (
    <>
      ...
      <aside className="glass-panel sticky top-24 hidden h-fit rounded-[30px] p-5 lg:block">
...
function BasicCompanionPanel({
  ...
  return (
    <aside className="space-y-4">
      ...
      <div id="upcoming-gatherings" className="glass-panel rounded-[28px] p-5">
...
function BasicProgramContent() {
  ...
  return (
    <div className="section-shell pb-16 pt-6 sm:pb-24 sm:pt-8">
