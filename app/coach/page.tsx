...
const isolationCopy = {
  jp: {
    title: "現在ご利用いただけません",
    body: "共生コーチは、安全性の確認が完了するまで一時的にご利用いただけません。今は、承認済みの1-Minute Recoveryに戻ることができます。",
    cta: "1-Minute Recoveryに戻る"
  },
  kr: {
    title: "현재 이용할 수 없습니다",
    body: "공생 코치는 안전 검토가 완료될 때까지 일시적으로 이용할 수 없습니다. 지금은 승인된 1-Minute Recovery로 돌아갈 수 있습니다.",
    cta: "1-Minute Recovery로 돌아가기"
  },
  en: {
    title: "Currently unavailable",
    body: "Gongsaeng Coach is temporarily unavailable while its safety review is completed. For now, you can return to the approved 1-Minute Recovery experience.",
...
export default function CoachPage() {
  ...
  const copy = isolationCopy[language];
