    ...
    <section id="daily-rhythm-check" className="section-shell mt-10 sm:mt-12">
      <div className="relative overflow-hidden rounded-[30px] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(245,241,228,0.12),transparent_20%),radial-gradient(circle_at_bottom,rgba(79,122,101,0.14),transparent_30%),linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-5 py-6 shadow-[0_24px_80px_rgba(7,17,31,0.16)] sm:px-7 sm:py-7">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-3 font-serif text-3xl leading-tight text-white sm:text-4xl">{copy.title}</h2>
          <p className="mt-3 text-base leading-8 text-white/68 sm:text-lg">{copy.description}</p>
          ...
          {copy.options.map((option) => {
            ...
            return (
              <button
                ...
                className={`min-h-[56px] rounded-2xl border px-4 py-4 text-sm leading-7 transition duration-300 ${
                  isSelected
        ...
        <div className="mx-auto mt-5 max-w-2xl rounded-[24px] border border-emerald-200/12 bg-emerald-200/8 px-5 py-5 text-center transition duration-500 animate-[fadeIn_400ms_ease-out] sm:px-6">
