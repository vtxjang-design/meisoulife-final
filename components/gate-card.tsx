    ...
    >
      <div className="space-y-2">
        ...
        <div className="space-y-1.5">
          <p className="text-[15px] font-semibold leading-[1.25] text-white sm:text-[16px]">{label}</p>
          <p className="font-serif text-[13px] leading-[1.45] text-gold/84 sm:text-[14px]">{worldName}</p>
