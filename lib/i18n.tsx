...
export const siteCopy = {
  jp: {
    ...
    challengePage: {
      ...
      endTitle: "Do you want to continue this rhythm?",
      endDescription: "7日間を通して生まれた小さな変化を、そのまま毎日のリズムとして育てていくことができます。",
  ...
  kr: {
    ...
    challengePage: {
      ...
      endTitle: "Do you want to continue this rhythm?",
      endDescription: "7일 동안 생긴 작은 변화를, 그대로 매일의 리듬으로 이어갈 수 있습니다.",
      memberButton: "Continue with membership",
      repeatButton: "Stay with free",
      days: [
  ...
  en: {
    ...
    challengePage: {
      ...
      endTitle: "Do you want to continue this rhythm?",
      endDescription: "The small change you felt over these seven days can keep growing as part of your daily life.",
      memberButton: "Continue with membership",
      repeatButton: "Stay with free",
      days: [
