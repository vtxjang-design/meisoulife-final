...
export const siteCopy = {
  jp: {
    ...
    loginPage: {
      ...
      resetRequestTitle: "パスワードを再設定する",
      resetRequestSubtitle: "登録したメールアドレスを入力してください。安全な再設定リンクをお送りします。",
      resetRequestButton: "再設定リンクを送る",
      resetRequestSending: "送信中...",
      resetRequestBack: "ログインに戻る",
      resetRequestSuccess: "パスワード再設定リンクを送信しました。受信箱と迷惑メールフォルダをご確認ください。",
      resetRequestError: "パスワード再設定リンクを送信できませんでした。",
      resetRequestEmailRequired: "登録したメールアドレスを入力してください。",
      resetPageTitle: "新しいパスワードを設定する",
      resetPageSubtitle: "確認メールのリンクから戻ったあと、新しいパスワードを設定してください。",
      resetPageButton: "新しいパスワードを保存する",
      resetPageSuccess: "新しいパスワードを設定しました。もう一度ログインしてください。",
      resetPageError: "パスワードを更新できませんでした。",
      passwordMismatch: "確認用パスワードが一致しません。",
      resetPageInvalid: "再設定リンクの確認ができませんでした。もう一度お試しください。",
      loginAgain: "ログイン画面へ",
      checking: "確認しています...",
  ...
  kr: {
    ...
    loginPage: {
      ...
      resetRequestSubtitle: "등록된 이메일을 입력해 주세요. 안전한 재설정 링크를 보내드립니다.",
      resetRequestButton: "재설정 링크 보내기",
      resetRequestSending: "전송 중...",
      resetRequestBack: "로그인으로 돌아가기",
      resetRequestSuccess: "재설정 링크를 이메일로 보냈습니다. 메일함과 스팸함을 확인해 주세요.",
      resetRequestError: "비밀번호 재설정 링크를 보내지 못했습니다.",
      resetRequestEmailRequired: "등록된 이메일을 입력해 주세요.",
      resetPageTitle: "새 비밀번호 설정",
      resetPageSubtitle: "이메일의 링크로 돌아오신 뒤, 새로운 비밀번호를 설정해 주세요.",
      resetPageButton: "새 비밀번호 저장",
      resetPageSuccess: "새 비밀번호가 설정되었습니다. 다시 로그인해 주세요.",
      resetPageError: "비밀번호를 업데이트하지 못했습니다.",
      passwordMismatch: "비밀번호 확인이 일치하지 않습니다.",
      resetPageInvalid: "재설정 링크를 확인하지 못했습니다. 다시 시도해 주세요.",
      loginAgain: "로그인 화면으로",
      checking: "확인하고 있습니다...",
  ...
  en: {
    ...
    loginPage: {
      ...
      resetRequestSubtitle: "Enter your registered email and we will send you a secure reset link.",
      resetRequestButton: "Send reset link",
      resetRequestSending: "Sending...",
      resetRequestBack: "Back to login",
      resetRequestSuccess: "Password reset link has been sent. Please check your inbox and spam folder.",
      resetRequestError: "We could not send the password reset link.",
      resetRequestEmailRequired: "Please enter your registered email address.",
      resetPageTitle: "Set a new password",
      resetPageSubtitle: "After opening your email link, set a new password here.",
      resetPageButton: "Save new password",
      resetPageSuccess: "Your new password has been saved. Please log in again.",
      resetPageError: "We could not update your password.",
      passwordMismatch: "The confirmation password does not match.",
      resetPageInvalid: "We could not confirm your reset link. Please try again.",
